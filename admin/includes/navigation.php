...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <ul class="nav navbar-right top-nav"> 
      ...
      <li><a href=""><span class="usersonline"></span><button type="button" class="btn-success"></button>
        Users online </a></li>
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse col-md-2">
        <ul class="nav navbar-nav side-nav">
            ...
            <li>
                ...
                <ul id="posts_dropdown" class="collapse">
                    <li>
                        <a href="posts.php?source=users_posts">My Posts</a>
                    </li>
                    <li >
                        <a href="posts.php" name="posts">View all posts</a>
                    </li>
                    <li>
